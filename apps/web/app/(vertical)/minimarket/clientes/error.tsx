...
export default function ClientesError({
  ...
  React.useEffect(() => {
    captureError(error, { digest: error.digest, modulo: "minimarket/clientes" });
  }, [error]);
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <Card className="flex flex-col items-center gap-3 p-12 text-center">
        ...
        <p className="text-heading font-medium">No se pudo cargar los clientes</p>
        <p className="text-muted-foreground max-w-sm text-sm">
          Error al cargar la lista de clientes. Inténtalo de nuevo.
        </p>
