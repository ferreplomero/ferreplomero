...
export default function VentasError({
  ...
  React.useEffect(() => {
    captureError(error, { digest: error.digest, modulo: "minimarket/ventas" });
  }, [error]);
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <Card className="flex flex-col items-center gap-3 p-12 text-center">
        ...
        <p className="text-heading font-medium">No se pudo cargar el historial de ventas</p>
        <p className="text-muted-foreground max-w-sm text-sm">
          Ocurrió un error al consultar las ventas. Inténtalo de nuevo.
        </p>
