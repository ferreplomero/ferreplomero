...
export default function ComprasError({
  ...
  React.useEffect(() => {
    captureError(error, { digest: error.digest, modulo: "minimarket/compras" });
  }, [error]);
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <Card className="flex flex-col items-center gap-3 p-12 text-center">
        ...
        <p className="text-heading font-medium">No se pudo cargar las compras</p>
        <p className="text-muted-foreground max-w-sm text-sm">
          Error al cargar el historial de compras. Inténtalo de nuevo.
        </p>
