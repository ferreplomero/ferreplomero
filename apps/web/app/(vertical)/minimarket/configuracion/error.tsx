...
export default function ConfiguracionError({
  ...
  React.useEffect(() => {
    captureError(error, { digest: error.digest, modulo: "minimarket/configuracion" });
  }, [error]);
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <Card className="flex flex-col items-center gap-3 p-12 text-center">
        ...
        <p className="text-heading font-medium">No se pudo cargar la configuración</p>
        <p className="text-muted-foreground max-w-sm text-sm">
          Error al cargar los datos de configuración. Inténtalo de nuevo.
        </p>
