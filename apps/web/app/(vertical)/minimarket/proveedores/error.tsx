...
export default function ProveedoresError({
  ...
  React.useEffect(() => {
    captureError(error, { digest: error.digest, modulo: "minimarket/proveedores" });
  }, [error]);
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <Card className="flex flex-col items-center gap-3 p-12 text-center">
        ...
        <p className="text-heading font-medium">No se pudo cargar los proveedores</p>
        <p className="text-muted-foreground max-w-sm text-sm">
          Error al cargar el listado de proveedores. Inténtalo de nuevo.
        </p>
