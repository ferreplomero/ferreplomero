...
export default function ReportesError({
  ...
  React.useEffect(() => {
    captureError(error, { digest: error.digest, modulo: "minimarket/reportes" });
  }, [error]);
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <Card className="flex flex-col items-center gap-3 p-12 text-center">
        ...
        <p className="text-heading font-medium">No se pudo cargar los reportes</p>
        <p className="text-muted-foreground max-w-sm text-sm">
          Error al generar los reportes del período. Inténtalo de nuevo.
        </p>
